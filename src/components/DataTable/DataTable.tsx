...
const DataTable: FunctionComponent<DataTableProps> = (props) => {
    ...
    const {className, columns, data, rowsPerPageOptions, component, count, rowsPerPage, page, handleChangePage, handleChangeRowsPerPage, handleDeleteCase, onClickRow, deleteFlag, editFlag} = props;
    return (
        <div>
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            {deleteFlag && <IconButton
                                                onClick={(e: MouseEvent<HTMLElement>) => handleDeleteCase(row.id, e)}
