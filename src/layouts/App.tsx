                    ...
                    <AppBar className="app-header" position="static" color="primary">
                        <Toolbar>
                            ...
                            <Typography variant="h6" className="typography">
                                <Link to="/mcm/dashboard">MyLicense Case Management</Link>
                            </Typography>
                            <Hidden mdUp={true}>
                                <Box m={2}>
                                    <MenuIcon onClick={this.toggleDrawer(true)} />
                                </Box>
                                <Drawer anchor="right" open={drawerState} onClose={this.toggleDrawer(false)}>
                                    <ListItem button key={1}>
                                        <Link to="/mcm/cases" onClick={this.toggleDrawer(false)}>
                                    ...
                                    <ListItem button key={3}>
                                        <Link to="/mcm/reminders" onClick={this.toggleDrawer(false)}>
                            ...
                            <Hidden smDown={true}>
                                <div className="nav-routes">
                                    <Link
                                        to="/mcm/cases"
                                        className={`nav-link ${pathname === '/cases' ? 'active' : ''}`}
                                    >
                                        Cases
                                    </Link>
                  ...
                  <Search fontSize="large" />
                    ...
                    <div className="page-wrapper">
                        <Switch>
                            ...
                            {/* TODO: For MVP we need to land on cases page. Later it will be changed to Dashboard */}
                            <Redirect exact from="/" to="/mcm/cases" />
                        </Switch>
                    </div>
                </ThemeProvider>
            </div>
